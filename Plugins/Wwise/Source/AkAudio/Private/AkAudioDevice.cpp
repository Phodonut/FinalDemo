...
#include <AK/Plugin/Hv_test_laser_WwiseSourcePluginFactory.h>
#include <AK/Plugin/Hv_cricket_patchv4_WwiseSourcePluginFactory.h>
...
void FAkAudioDevice::SetSpatialAudioListener(UAkComponent* in_pListener)
{
...
void FAkAudioDevice::RemoveDefaultListener(UAkComponent* in_pListener)
{
	...
	{
		SetSpatialAudioListener(m_defaultListeners.Array()[0]);
	}
}
